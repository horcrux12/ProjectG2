...
class TableUser extends Component {
    ...
    getData = () => {
        ...
        let url = `http://localhost:8080/api/users?role=User&limit=${limit}&offset=${offset}`;
        if (search != "") {
            url += `&search=${search}`;
        }
        fetch(`${url}`, {
            ...
            <div className="table-user">
                ...
                <div className="header-table">
                    ...
                    <div className="button-tambah">
                            <Button class="btn btn-hijau tambah" funcClick={this.tambahButton}>Tambah data User</Button>
                        {/* <Link to="/tambah">
                        </Link> */}
                    </div>
                </div>
